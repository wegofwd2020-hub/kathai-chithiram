...
| R10 | Operator browses story content | Medium | Access scoped to the owning session; no broad operator browsing (PRIVACY.md §7). Enforcement beyond convention is an **infra control, not yet built**. | Medium |
